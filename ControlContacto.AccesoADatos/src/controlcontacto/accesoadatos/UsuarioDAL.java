...
import java.util.*;
import java.sql.*;
import controlcontactos.entidadesdenegocio.*; // Agregar la referencia al proyecto de entidades de negocio y poder utilizar las entidades de Rol y Usuario
...
public class UsuarioDAL {
    ...
    private static void obtenerDatos(PreparedStatement pPS, ArrayList<Usuario> pUsuarios) throws Exception {
        try (ResultSet resultSet = ComunBD.obtenerResultSet(pPS);) { // obtener el ResultSet desde la clase ComunDB
